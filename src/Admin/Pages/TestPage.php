...
final class TestPage {
	...
	const NONCE_ACTION = 'sendsms_fwc_test_send';
			...
			<form method="post" action="">
				...
				<table class="form-table">
					<tbody>
						<tr>
							<th scope="row">
								<label for="sendsms-fwc-test-phone"><?php esc_html_e( 'Phone number', 'sendsms-for-woocommerce' ); ?></label>
							</th>
							<td>
								<input id="sendsms-fwc-test-phone" type="text" name="wc_sendsms_phone" style="width: 400px;" required />
							</td>
						</tr>
						<tr>
							...
							<td>
								<label>
									<input type="checkbox" name="wc_sendsms_url" value="1" />
						...
						<tr>
							...
							<td>
								<label>
									<input type="checkbox" name="wc_sendsms_gdpr" value="1" />
						...
						<tr>
							<th scope="row">
								<label for="sendsms-fwc-test-message"><?php esc_html_e( 'Message', 'sendsms-for-woocommerce' ); ?></label>
							</th>
							<td>
								<textarea id="sendsms-fwc-test-message" name="wc_sendsms_message" class="sendsms-fwc-content" style="width: 400px; height: 100px;" required></textarea>
	...
	private function maybe_handle_submission(): void {
		...
		$raw_phone   = isset( $_POST['wc_sendsms_phone'] )   ? sanitize_text_field( wp_unslash( $_POST['wc_sendsms_phone'] ) )   : '';
		$raw_message = isset( $_POST['wc_sendsms_message'] ) ? sanitize_textarea_field( wp_unslash( $_POST['wc_sendsms_message'] ) ) : '';
		$short       = isset( $_POST['wc_sendsms_url'] );
		$gdpr        = isset( $_POST['wc_sendsms_gdpr'] );
