...
/**
 * Static lookup of ISO-3166 alpha-2 → dial code.
 *
 * Data preserved from the v1.x `cc.php` file. Duplicate keys in the source
 * (e.g. DO, PR, VA, XN) collapse to last-wins per PHP semantics.
 */
final class CountryCodes {
	...
	/**
	 * Get the dial code for a country, or empty string if unknown.
	 *
	 * @param string $iso ISO-3166 alpha-2 code, e.g. "RO", "IT".
	 * @return string Dial code without the leading '+', or '' if not found.
	 */
	public static function dial_code_for( string $iso ): string {
		$map = self::all();
		return $map[ $iso ] ?? '';
	}
	...
	public static function all(): array {
		...
		self::$map = array(
			...
			'DO' => '1849', 'DZ' => '213', 'EC' => '593', 'EE' => '372', 'EG' => '20',
			'EH' => '212', 'ER' => '291', 'ES' => '34', 'ET' => '251', 'EU' => '388',
			...
			'PH' => '63', 'PK' => '92', 'PL' => '48', 'PM' => '508', 'PR' => '1939',
			'PS' => '970', 'PT' => '351', 'PW' => '680', 'PY' => '595', 'QA' => '974',
			'QN' => '374', 'QS' => '252', 'QY' => '90', 'RE' => '262', 'RO' => '40',
			...
			'XC' => '991', 'XD' => '888', 'XG' => '881', 'XL' => '883', 'XN' => '870',
			'XP' => '878', 'XR' => '979', 'XS' => '808', 'XT' => '800', 'XV' => '882',
